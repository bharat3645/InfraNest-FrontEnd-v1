...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#0a0a0a] border-t border-[#333333] text-white">
      {/* Main Footer Content */}
      ...
      {/* Bottom Bar */}
      <div className="border-t border-[#333333] bg-[#111111]">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-5">
        <div className="absolute inset-0 bg-gradient-to-t from-[#00ff88]/10 via-transparent to-transparent"></div>
      </div>
    </footer>
  );
};
